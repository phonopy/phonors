...
/// Public: BZ-grid neighbours of many `grid_points` along a list of
/// relative grid addresses.  Mirrors `ph3py_get_neighboring_gird_points`.  `out`
...
pub(crate) fn fill_neighboring_grid_points(
    out: &mut [i64],
    grid_point: i64,
    relative_grid_address: &[Vec3I],
    bzgrid: &BzGridView,
